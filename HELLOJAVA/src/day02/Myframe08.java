	...
	public Myframe08() {
		...
		btn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int mine = tfMine.getText().equals("가위") ? 0 : tfMine.getText().equals("바위") ? 1 : 2;
				String s_com = com == 0 ? "가위" : com == 1 ? "바위" : "보";
				String result = mine - com == 1 || mine - com == -2 ? result = "승리" : mine == com ? "무승부" : "패배";
				tfCom.setText(s_com);
